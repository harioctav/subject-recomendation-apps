  ...
  js: {
    ...
    plugins: {
      ...
      'ckeditor5-classic': {
        ...
        src: ['node_modules/@ckeditor/ckeditor5-build-classic/**/*.*', '!node_modules/@ckeditor/ckeditor5-build-classic/package.json'],
        dest: path.src.jsplugins + 'ckeditor5-classic/'
      },
      'ckeditor5-inline': {
        base: path.src.jsplugins + 'ckeditor5-inline/',
        src: ['node_modules/@ckeditor/ckeditor5-build-inline/**/*.*', '!node_modules/@ckeditor/ckeditor5-build-inline/package.json'],
      ...
      'jquery-countdown': {
        base: path.src.jsplugins + 'jquery-countdoscrwn/',
      ...
      vide: {
        base: path.src.jsplugins + 'jquery-vide/',
        src: 'node_modules/vide/dist/**/*.*',
        dest: path.src.jsplugins + 'jquery-vide/'
      },
      'magnific-popup': {
      ...
      'jquery.maskedinput': {
        base: path.src.jsplugins + 'masked-inputs/',
        src: 'node_modules/jquery.maskedinput/src/jquery.maskedinput.js',
        dest: path.src.jsplugins + 'masked-inputs/',
        min: true
      },
      select2: {
      ...
      'pwstrength-bootstrap': {
        base: path.src.jsplugins + 'pwstrength-bootstrap/',
        src: 'node_modules/pwstrength-bootstrap/dist/**/*.*',
        dest: path.src.jsplugins + 'pwstrength-bootstrap/'
      },
      nestable2: {
        base: path.src.jsplugins + 'nestable2/',
        src: 'node_modules/nestable2/dist/**/*.*',
        dest: path.src.jsplugins + 'nestable2/'
      },
      flatpickr: {
