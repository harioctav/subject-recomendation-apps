...
<div class="block block-rounded">
  <div class="block-header block-header-default">
    <h3 class="block-title">
      {{ trans('page.students.edit', ['students' => trans('page.students.title')]) }}
    </h3>
  </div>
        ...
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <select name="status" id="status" class="js-select2 form-select @error('status') is-invalid @enderror" data-placeholder="{{ trans('Pilih Salah Satu') }}" style="width: 100%;">
              ...
              <option value="{{ $value }}" @if (old('status', $student->status)==$value) selected @endif>{{ ucfirst(trans($value)) }}</option>
              @endforeach
            </select>
            @error('status')
            <div class="invalid-feedback">{{ $message }}</div>
          ...
          <div class="mb-4">
            ...
            <input type="text" name="upbjj" id="upbjj" value="{{ old('upbjj', $student->upbjj) }}" class="form-control @error('upbjj') is-invalid @enderror" placeholder="{{ trans('Masukkan UPBJJ') }}">
            @error('upbjj')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="text" name="parent_name" id="parent_name" value="{{ old('parent_name', $student->parent_name) }}" class="form-control @error('parent_name') is-invalid @enderror" placeholder="{{ trans('Masukkan Nama Wali') }}" onkeypress="return onlyLetter(event)">
            @error('parent_name')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
