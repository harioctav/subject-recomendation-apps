...
@endcan
@can('majors.show')
<a href="{{ route('majors.show', $uuid) }}" class="text-primary me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ trans('page.majors.show') }}"><i class="fa fa-sm fa-eye"></i></a>
@endcan
@can('majors.destroy')
