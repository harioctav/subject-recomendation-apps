      ...
      <div class="row items-push">
        ...
        <div class="col-lg-7 offset-lg-1">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="form-control @error('phone') is-invalid @enderror" placeholder="{{ trans('Telepon') }}" onkeypress="return onlyNumber(event)">
            @error('phone')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
